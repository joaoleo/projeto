            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::model($projeto, ['url' => '/projetos/' . $projeto->id, 'method' => 'PUT', 'class' => 'form-horizontal form-label-left']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('status', ['aberto' => 'Aberto', 'finalizado' => 'Finalizado', 'aguardando' => 'Aguardando', 'cancelado' => 'Cancelado'], null, ['class' => 'form-control']) !!}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::date('data_inicio', $projeto->data_inicio, ['class' => 'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('data_limite', 'Data Limite:') !!}
                                {!! Form::date('data_limite', $projeto->data_limite, ['class' => 'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('prazo_final', 'Prazo Final:') !!}
                                {!! Form::date('prazo_final', $projeto->prazo_final, ['class' => 'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('data_termino', 'Data Término:') !!}
                                {!! Form::date('data_termino', $projeto->data_termino, ['class' => 'form-control']) !!}
                            </div>

                            <div class="form-group">
                                {!! Form::label('descricao', 'Descrição:') !!}
                                {!! Form::textarea('descricao', null, ['class' => 'form-control', 'rows' => 4, 'placeholder' => 'Descrição']) !!}
                            </div>
